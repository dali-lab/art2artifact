...
<html>
    ...
    <body style="background-image: url(Content/Login_map.jpg); background-size: 100%;">
		...
		<div style="width: 100%; height: 100%; padding: 20px; background-color: rgba(250, 250, 250, 0.75); border-color: black;">

            <center>
                <h1>Edit Personal Info:</h1>
			</center>	
			<div class="modal" style="position: relative; top: auto; left: auto; right: auto; margin: 0 auto 20px; z-index: 1; max-width: 100%;">
                <form action="edit_user_php.php" method="post" ENCTYPE="multipart/form-data" class="form-horizontal" id="edit-user" style="margin-top: 10px; margin-left: 10px; margin-bottom: 20px;">
					...
					<?php
				       ...
				       $db->edit_user_info($_SESSION['email'], $_SESSION['password']);
